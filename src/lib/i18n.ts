...
const resources = {
  en: {
    translation: {
      ...
      room_templates: 'Room Templates',
      room_template: 'Room Template',
      create_room_template: 'Create Room Template',
      edit_room_template: 'Edit Room Template',
      delete_room_template: 'Delete Room Template',
      use_template: 'Use Template',
      add_template_room: 'Add Template Room',
      room_template_created: 'Room template created successfully!',
      room_template_updated: 'Room template updated successfully!',
      room_template_deleted: 'Room template deleted successfully!',
      room_template_used: 'Room created from template successfully!',
      no_room_templates: 'No room templates available',
      create_new_template: 'Create New Template',
      template_tasks: 'Template Tasks',
      add_task_to_template: 'Add Task to Template',
      cascade_update: 'Update all rooms using this template',
      cascade_delete: 'Delete all rooms using this template',
      template_in_use: 'Template in Use',
      template_usage: 'This template is currently being used by {count} room(s)',
      cascade_update_warning: 'This will update all rooms and tasks created from this template',
      cascade_delete_warning: 'This will delete all rooms and tasks created from this template',
