...
export const employeeInterfaceService = {
  ...
  async getTasksForEmployee(siteId: number, employeeId: number): Promise<Array<{id:number; description:string; room:{id:number; name:string}|null; zone:{id:number; name:string}|null}>> {
